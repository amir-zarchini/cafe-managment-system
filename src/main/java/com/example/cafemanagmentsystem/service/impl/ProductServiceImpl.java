...
import com.example.cafemanagmentsystem.repository.ProductRepository;
		...
		try 
		{
			if(jwtFilter.isAdmin())
			{
				if(validateProductMap(requestMap,false))
				{
					...
					return CafeUtils.getResponseEntity("Product is Added To Category Successfully.", HttpStatus.OK);
				}
